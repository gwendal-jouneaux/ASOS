...
entryRuleSemanticAdaptation returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getSemanticAdaptationRule()); }
	iv_ruleSemanticAdaptation=ruleSemanticAdaptation
	{ $current=$iv_ruleSemanticAdaptation.current; }
	EOF;

// Rule SemanticAdaptation
ruleSemanticAdaptation returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleSemantics returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getSemanticsRule()); }
	iv_ruleSemantics=ruleSemantics
	{ $current=$iv_ruleSemantics.current; }
	EOF;

// Rule Semantics
ruleSemantics returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleCondIs returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getCondIsRule()); }
	iv_ruleCondIs=ruleCondIs
	{ $current=$iv_ruleCondIs.current; }
	EOF;

// Rule CondIs
ruleCondIs returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
@after {
	...
	(
		...
		{
			$current = $this_Atomic_13.current;
			afterParserOrEnumRuleCall();
		}
	)
;
