...
/**
 * This is the item provider adapter for a {@link fr.irisa.diverse.adaptivesemantics.model.adaptivesemantics.Conclusion} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ConclusionItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addTerminationPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Conclusion_termination_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Conclusion_termination_feature",
								"_UI_Conclusion_type"),
						AdaptivesemanticsPackage.Literals.CONCLUSION__TERMINATION, true, false, false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(AdaptivesemanticsPackage.Literals.CONCLUSION__FROM);
			childrenFeatures.add(AdaptivesemanticsPackage.Literals.CONCLUSION__TO);
		}
	...
	public String getText(Object object) {
		...
		return getString("_UI_Conclusion_type") + " " + conclusion.isTermination();
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(AdaptivesemanticsPackage.Literals.CONCLUSION__FROM,
