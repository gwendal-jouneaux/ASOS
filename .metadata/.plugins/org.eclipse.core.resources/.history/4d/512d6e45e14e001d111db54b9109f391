...
/**
 * This is the item provider adapter for a {@link fr.irisa.diverse.adaptivesemantics.model.adaptivesemantics.Input} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
	...
	protected void addOperationPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Input_operation_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Input_operation_feature",
								"_UI_Input_type"),
						AdaptivesemanticsPackage.Literals.INPUT__OPERATION, true, false, true, null, null, null));
	}
