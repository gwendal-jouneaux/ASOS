 ...
 * </p>
 * <ul>
 *   <li>{@link semanticadaptation.impl.SemanticsImpl#getImportURI <em>Import URI</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SemanticsImpl extends MinimalEObjectImpl.Container implements Semantics {
	...
	protected EClass eStaticClass() {
		return SemanticadaptationPackage.Literals.SEMANTICS;
	}
	...
	public void setImportURI(String newImportURI) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SemanticadaptationPackage.SEMANTICS__IMPORT_URI,
