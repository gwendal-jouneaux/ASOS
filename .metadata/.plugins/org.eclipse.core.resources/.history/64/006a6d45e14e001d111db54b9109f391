...
/**
 * This is the item provider adapter for a {@link fr.irisa.diverse.adaptivesemantics.model.adaptivesemantics.Configuration} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
	...
	protected void addConceptPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Configuration_concept_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Configuration_concept_feature",
								"_UI_Configuration_type"),
						AdaptivesemanticsPackage.Literals.CONFIGURATION__CONCEPT, true, false, true, null, null, null));
	}
