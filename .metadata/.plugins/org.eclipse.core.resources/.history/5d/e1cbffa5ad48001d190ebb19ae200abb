...
/**
 * This is the item provider adapter for a {@link fr.irisa.diverse.adaptivesemantics.model.adaptivesemantics.Import} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ImportItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Import_importURI_feature",
								"_UI_Import_type"),
						AdaptivesemanticsPackage.Literals.IMPORT__IMPORT_URI, true, false, false,
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Import_name_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Import_name_feature", "_UI_Import_type"),
						AdaptivesemanticsPackage.Literals.IMPORT__NAME, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	public void notifyChanged(Notification notification) {
		...
		case AdaptivesemanticsPackage.IMPORT__IMPORT_URI:
		case AdaptivesemanticsPackage.IMPORT__NAME:
