 ...
 * </p>
 * <ul>
 *   <li>{@link fr.irisa.diverse.adaptivesemantics.model.adaptivesemantics.impl.NotImpl#getExpr <em>Expr</em>}</li>
 * </ul>
 *
 * @generated
 */
public class NotImpl extends MinimalEObjectImpl.Container implements Not {
	...
	protected EClass eStaticClass() {
		return AdaptivesemanticsPackage.Literals.NOT;
	}
	...
	public NotificationChain basicSetExpr(Expr newExpr, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					AdaptivesemanticsPackage.NOT__EXPR, oldExpr, newExpr);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newExpr != expr) {
			...
			if (expr != null)
				msgs = ((InternalEObject) expr).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - AdaptivesemanticsPackage.NOT__EXPR, null, msgs);
			if (newExpr != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, AdaptivesemanticsPackage.NOT__EXPR, newExpr,
					newExpr));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case AdaptivesemanticsPackage.NOT__EXPR:
